// Content script for OpenAgent in Chrome extension.
...
(function () {
  ...
  // Wake the service worker on page load so native messaging stays alive.
  try { chrome.runtime.sendMessage({ type: "wakeup" }); } catch(e) {}
})();
