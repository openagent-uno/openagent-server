...
class BaseDb(ABC):
    ...
    def __init__(
        ...
        self.session_table_name = session_table or "sessions"
        self.culture_table_name = culture_table or "runtime_culture"
        self.memory_table_name = memory_table or "runtime_memories"
        self.metrics_table_name = metrics_table or "runtime_metrics"
        self.eval_table_name = eval_table or "runtime_eval_runs"
        self.knowledge_table_name = knowledge_table or "runtime_knowledge"
        self.trace_table_name = traces_table or "runtime_traces"
        self.span_table_name = spans_table or "runtime_spans"
        self.versions_table_name = versions_table or "runtime_schema_versions"
        self.components_table_name = components_table or "runtime_components"
        self.component_configs_table_name = component_configs_table or "runtime_component_configs"
        self.component_links_table_name = component_links_table or "runtime_component_links"
        self.learnings_table_name = learnings_table or "runtime_learnings"
        self.schedules_table_name = schedules_table or "runtime_schedules"
        self.schedule_runs_table_name = schedule_runs_table or "runtime_schedule_runs"
        self.approvals_table_name = approvals_table or "runtime_approvals"
